...
//life_event = true;
_message = "This is not a test. This is your emergency broadcast system announcing the commencement of the Annual Purge sanctioned by the Altis Government. If you do not want to participate, stay in a safezone until The Purge has ended. VDM is NOT allowed!";[[_message,name player,6],"TON_fnc_clientMessage",true,false] spawn life_fnc_MP;
