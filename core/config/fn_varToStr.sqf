...
switch (_var) do
{
	...
	case "life_inv_salemaraw": {(localize "STR_Item_Salema")};
	case "life_inv_ornateraw": {(localize "STR_Item_OrnateMeat")};
	case "life_inv_mackerelraw": {(localize "STR_Item_MackerelMeat")};
	case "life_inv_tunaraw": {(localize "STR_Item_TunaMeat")};
	case "life_inv_mulletraw": {(localize "STR_Item_MulletMeat")};
	case "life_inv_catsharkraw": {(localize "STR_Item_CatSharkMeat")};
	...
	case "life_inv_ecstasyu": {(localize "STR_Item_ecstasyU")};
	case "life_inv_ecstasyp": {(localize "STR_Item_ecstasyP")};
	case "life_inv_mushroomu": {(localize "STR_Item_mushroomU")};
	case "life_inv_mushroomp": {(localize "STR_Item_mushroomP")};
	case "life_inv_riceu": {(localize "STR_Item_riceu")};
	case "life_inv_ricep": {(localize "STR_Item_riceP")};
	case "life_inv_zincu": {(localize "STR_Item_zincU")};
	case "life_inv_zincp": {(localize "STR_Item_zincP")};
	case "life_inv_silveru": {(localize "STR_Item_silverU")};
	case "life_inv_silverp": {(localize "STR_Item_silverP")};
	case "life_inv_sugaru": {(localize "STR_Item_sugarU")};
	case "life_inv_sugarp": {(localize "STR_Item_sugarP")};
	case "life_inv_sandwich": {(localize "STR_Item_sandwich")};
	case "life_inv_twister": {(localize "STR_Item_twister")};
	case "life_inv_whiskey": {(localize "STR_Item_whiskey")};
	case "life_inv_beer": {(localize "STR_Item_beer")};
	case "life_inv_cider": {(localize "STR_Item_cider")};
	...
	case "license_cop_military": {(localize "STR_License_military")};
	...
	case "license_civ_mushroom": {(localize "STR_License_mushroom")};
	case "license_civ_sugar": {(localize "STR_License_sugar")};
	case "license_civ_rice": {(localize "STR_License_rice")};
	case "license_civ_zinc": {(localize "STR_License_zinc")};
};
