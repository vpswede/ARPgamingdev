...
if(!((player distance (getMarkerPos "cop_spawn_1") < 100) OR  (player distance (getMarkerPos "police_hq_2") < 200) OR (player distance (getMarkerPos "cop_spawn_3") < 100) OR (player distance (getMarkerPos "cop_air_2") < 100) OR (player distance (getMarkerPos "cop_spawn_5") < 30))) then  {
