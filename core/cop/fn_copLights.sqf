...
private ["_veh","_lightWhite","_lightBlue","_lightsOn","_brightnessHigh","_brightnessLow","_attach","_leftLights","_rightLights","_type","_attenuation"];
...
_attach =
{
    ...
    switch (_color) do
    {
        ...
        case "blue1": { _light setLightColor _lightBlue; };
    };
...
switch (_type) do
{
    case "C_Offroad_01_F":
    {
        ...
        [true, "blue1", [0.345, 0, 0.525]] call _attach;
        [false, "blue", [0.575, -2.95, -0.77]] call _attach;
        [true, "blue1", [-0.645, -2.95, -0.77]] call _attach;
    ...
    case "C_SUV_01_F":
    {
        ...
        [true, "blue1", [0.38, 2.28, -0.52]] call _attach;
        [false, "blue", [-0.86, -2.75, -0.18]] call _attach;
        [true, "blue1", [0.86, -2.75, -0.18]] call _attach;
    ...
    case "C_Hatchback_01_sport_F":
    {
        ...
        [true, "blue1", [-0.03, -0, 0.2]] call _attach;
        [false, "blue", [-0.8, -2.25, -0.3]] call _attach;
        [true, "blue1", [0.78, -2.25, -0.3]] call _attach;
    ...
    case "B_MRAP_01_F":
    {
        ...
        [true, "blue1", [0.85, -0.9, 0.6]] call _attach;
        [true, "blue", [-0.93, -2.8, 0.6]] call _attach;
        [false, "blue1", [0.93, -2.8, 0.6]] call _attach;
    ...
    {
        [true,"blue1", [-0.07, 1, -0.7]] call _attach;
