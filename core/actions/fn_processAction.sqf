...
_itemInfo = switch (_type) do {
	...
	case "lsd": {["frog","lsd",450,(localize "STR_Process_LSD")];};
	case "ecstasy": {["ecstasy_unprocessed","ecstasy_processed",450,(localize "STR_Process_Ecstasy")];};
	case "mushroom": {["mushroom_unprocessed","mushroom_processed",450,(localize "STR_Process_Mushroom")];};
	case "sugar": {["sugar_unprocessed","sugar_processed",450,(localize "STR_Process_sugar")];};
	case "rice": {["rice_unprocessed","rice_processed",450,(localize "STR_Process_rice")];};
	case "zinc": {["zinc_unprocessed","zinc_processed",450,(localize "STR_Process_zinc")];};
	case "silver": {["silver_unprocessed","silver_processed",450,(localize "STR_Process_silver")];};
	default {[];};
};
