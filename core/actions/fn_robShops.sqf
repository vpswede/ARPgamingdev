...
_chance = random(100);
if(_chance >= 1) then { hint "The cashier hit the silent alarm, police has been alerted!"; [[1,format["ALARM! - Gasstation is being robbed!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; };
