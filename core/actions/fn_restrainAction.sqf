...
if(playerSide == civilian) then {hint "You have restrained your target!";};
...
[[0,"STR_NOTF_Restrained",true,[_unit getVariable["realname", name _unit], profileName]],"life_fnc_broadcast",east,false] call life_fnc_MP;