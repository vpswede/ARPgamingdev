...
if(playerSide == west) then {
	...
	_Btn7 ctrlSetText localize "STR_vInAct_Breach";
    _Btn7 buttonSetAction "[] spawn life_fnc_breach;";
} else {
	...
	if (playerSide isEqualTo independent) then {
        _Btn3 ctrlSetText localize "STR_vInAct_Breach";
        _Btn3 buttonSetAction "[] spawn life_fnc_breach;";
        _Btn3 ctrlShow true;
    } else {
